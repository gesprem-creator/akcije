    ...
    <ResponsiveContainer width="100%" height={300}>
      <BarChart data={chartData} layout="vertical" margin={{ top: 5, right: 30, left: 20, bottom: 5 }}>
        ...
        <YAxis 
          type="category" 
          dataKey="symbol" 
          tick={{ fill: color, fontSize: 12, fontWeight: 'bold' }}
          width={60}
        />
        <Tooltip 
          contentStyle={{ 
            ...
            {!searchQuery && (
              <>
                ...
                <div className="flex items-center gap-2 text-sm text-muted-foreground">
                  ...
                  <span>Učitano <strong className="text-foreground">{data.totalStocks}</strong> akcija</span>
                </div>
                ...
                <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
                  ...
                  />
                  <SummaryCard
                    title="Biggest Gainer (10D)"
                    value={data.topGainers10Day[0] ? formatPercent(data.topGainers10Day[0].day10Pct) : 'N/A'}
                    subtitle={data.topGainers10Day[0]?.symbol || ''}
                    icon={TrendingUp}
                    trend="up"
